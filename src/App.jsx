...
const SPOTS = {
  ...
  gland: { name: 'G-Land', region: 'East Java, Indonesia', blurb: 'A legendary, remote left reef break inside a jungle bay.', lat: -8.6360, lon: 114.3660, offshoreDeg: 35 },
  ...
  popoyo: { name: 'Popoyo', region: 'Nicaragua', blurb: "A hollow reef break on Nicaragua's Pacific coast, offshore almost every morning.", lat: 11.5060, lon: -86.1970, offshoreDeg: 90 },
  ...
  muine: { name: 'Mui Ne', region: 'Vietnam', blurb: 'A wind-exposed stretch of coast better known for kitesurfing, but surfable too.', lat: 10.9330, lon: 108.2830, offshoreDeg: 260 },
  laentrada: { name: 'La Entrada', region: 'Ecuador', blurb: "A left point on Ecuador's surf coast, part of a stretch popular with traveling surfers.", lat: -0.4800, lon: -80.4500, offshoreDeg: 90 },
  ...
  darne: { name: 'Darne', region: 'Mauritius', blurb: "A reef break off Mauritius, inside the island's fringing coral.", lat: -20.4200, lon: 57.7000, offshoreDeg: 90 },
  ...
  masnou: { name: 'Masnou', region: 'Catalonia, Spain', blurb: 'A Mediterranean beach break just north of Barcelona, small but rideable on a good day.', lat: 41.4780, lon: 2.3160, offshoreDeg: 270 },
