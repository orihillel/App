...
//
// This is 124KB of source -- 32.3KB gzipped as its own chunk, which was 27% of everything the
// browser had to download before the app could run, for hundreds of spots when the home screen
// shows one.
...
// ORDER, the bare id list -- 540 ids for 0.84KB gzipped, against 7.7KB for the catalog itself.
//
...
//
// As of this note, 258 of 540 spots carry an explicit swellWindow; the other 282 run on the
...
export const CATALOG = {
  ...
  playanegracr: { name: 'Playa Negra', region: 'Guanacaste, Costa Rica', blurb: 'Fast right over a rock reef, the wave that put this stretch of coast on the map.', lat: 10.335, lon: -85.85, offshoreDeg: 60 },
  avellanas: { name: 'Playa Avellanas', region: 'Guanacaste, Costa Rica', blurb: 'Beach and reef peaks along a quiet stretch north of Playa Negra.', lat: 10.41, lon: -85.84, offshoreDeg: 60 },
  ...
  k59: { name: 'K-59', region: 'La Libertad, El Salvador', blurb: 'Cobblestone right point named for the kilometre marker on the coast road.', lat: 13.49, lon: -89.39, offshoreDeg: 20 },
