...
export const SPOTS = {
  ...
  jaws: { name: 'Peʻahi (Jaws)', region: 'Maui, Hawaii', blurb: 'The most famous big-wave tow and paddle arena on Earth, breaking on an outer reef.', lat: 20.943, lon: -156.302, offshoreDeg: 200 },
  ...
  lobitos: { name: 'Lobitos', region: 'Piura, Peru', blurb: 'Cold, mechanical left points down a desert oil-town coastline.', lat: -4.452, lon: -81.281, offshoreDeg: 110 },
  ...
  klitmoller: { name: 'Klitmøller', region: 'Denmark', blurb: 'Known as Cold Hawaii: a reef and point setup on the Danish North Sea coast.', lat: 57.04, lon: 8.48, offshoreDeg: 110 },
  hoddevik: { name: 'Hoddevik', region: 'Norway', blurb: 'A sand-bottom bay ringed by cliffs, surfed under the midnight sun and the northern lights.', lat: 62.033, lon: 5.1, offshoreDeg: 110 },
  ...
  sealpoint: { name: 'Seal Point', region: 'Cape St Francis, South Africa', blurb: 'Long, ruler-edged right point immortalised in The Endless Summer.', lat: -34.21, lon: 24.838, offshoreDeg: 340 },
  ...
  hiltonbeach: { name: 'Hilton Beach', region: 'Tel Aviv, Israel', blurb: "The city's best-known break, crowded whenever a Mediterranean windswell arrives.", lat: 32.087, lon: 34.768, offshoreDeg: 110 },
  hollowtrees: { name: 'Hollow Trees', region: 'Mentawai Islands, Indonesia', blurb: 'A perfect, shallow right-hand reef barrel — one of the best waves in the world.', lat: -2.117, lon: 99.567, offshoreDeg: 70 },
  bingin: { name: 'Bingin', region: 'Bali, Indonesia', blurb: 'Short, intense left reef barrel below a cliff of stacked guesthouses.', lat: -8.808, lon: 115.113, offshoreDeg: 50 },
  ...
  winkipop: { name: 'Winkipop', region: 'Victoria, Australia', blurb: 'The fast, racy right next door to Bells, and the better wave when it is on.', lat: -38.369, lon: 144.279, offshoreDeg: 340 },
  crescenthead: { name: 'Crescent Head', region: 'New South Wales, Australia', blurb: 'A long, sloping right point that is spiritual home to Australian longboarding.', lat: -31.188, lon: 152.98, offshoreDeg: 250 },
  duranbah: { name: 'Duranbah', region: 'New South Wales, Australia', blurb: 'Punchy beach break beside the Tweed river mouth, the most surfed sand in the country.', lat: -28.166, lon: 153.551, offshoreDeg: 250 },
  ...
  gnaraloo: { name: 'Gnaraloo', region: 'Western Australia', blurb: 'Tombstones — a heavy, remote left reef at the edge of a station on the Ningaloo coast.', lat: -23.79, lon: 113.51, offshoreDeg: 110 },
